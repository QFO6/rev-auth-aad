...
import (
	...
	revauthaad "github.com/QFO6/rev-auth-aad/v2"
	revauthaadmodels "github.com/QFO6/rev-auth-aad/v2/app/models"
...
func (c *AppAuth) Authenticate(identity string) revel.Result {
	...
	// Only user identity(not email) allowed
	...
	loginLogDo := revmongo.New(loginLog)
